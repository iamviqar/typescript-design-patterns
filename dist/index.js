...
exports.main = main;
const Demo_1 = require("./creational/singleton/Demo");
const Demo_2 = require("./creational/factory-method/Demo");
const Demo_3 = require("./creational/abstract-factory/Demo");
const Demo_4 = require("./creational/builder/Demo");
const Demo_5 = require("./behavioral/observer/Demo");
async function main() {
    console.log('🚀 TypeScript Design Patterns Demo Runner');
    console.log('==========================================\n');
    const patterns = [
        { name: 'Singleton', demo: Demo_1.demonstrateSingleton, category: 'Creational' },
        { name: 'Factory Method', demo: Demo_2.demonstrateFactoryMethod, category: 'Creational' },
        { name: 'Abstract Factory', demo: Demo_3.demonstrateAbstractFactory, category: 'Creational' },
        { name: 'Builder', demo: Demo_4.demonstrateBuilder, category: 'Creational' },
        { name: 'Observer', demo: Demo_5.demonstrateObserver, category: 'Behavioral' }
    ];
    ...
    if (args.length === 0) {
        ...
        const pattern = patterns.find(p => p.name.toLowerCase().replace(/[-_\s]/g, '') === patternName);
        if (pattern) {
...
async function runInteractiveMode(patterns) {
